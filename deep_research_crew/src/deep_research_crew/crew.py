...
from deep_research_crew.utils import get_exa_api_key, load_env

# import the knowledge source
# from crewai.knowledge.source.text_file_knowledge_source import TextFileKnowledgeSource

# Load .env — sets MODEL, ANTHROPIC_API_KEY / OPENAI_API_KEY / OPENAI_BASE_URL, EXA_API_KEY
load_env()
...
class ParallelDeepResearchCrew:
    ...
    def research_planner(self) -> Agent:
        return Agent(
            ...
            llm=os.environ.get("MODEL", "anthropic/claude-opus-4-5"),
            verbose=True
        )
    ...
    def crew(self) -> Crew:
        ...
        return Crew(
            ...
            memory=False,  # memory requires OpenAI embedding API; disable for Anthropic/DeepSeek
